...
public class contact5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.contact_layout5);
        ...
        bouton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                callIntent.setData(Uri.parse("tel:0612345675"));
    ...
    protected void envoyerEmail(){
        Log.i("Send email", "");
        String[] TO = {"asmaa.retbi@gmail.com"};
        String[] CC = {""};
        ...
        try {
            ...
            Toast.makeText(contact5.this, "Pas de client mail installe", Toast.LENGTH_SHORT).show();
        }
