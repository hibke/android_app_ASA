...
public class contact3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.contact_layout3);
        ...
        bouton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                callIntent.setData(Uri.parse("tel:0612345673"));
    ...
    protected void envoyerEmail(){
        Log.i("Send email", "");
        String[] TO = {"driss.allaki@gmail.com"};
        String[] CC = {""};
        ...
        try {
            ...
            Toast.makeText(contact3.this, "Pas de client mail installe", Toast.LENGTH_SHORT).show();
        }
