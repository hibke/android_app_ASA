...
public class contact1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        bouton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                callIntent.setData(Uri.parse("tel:0612345671"));
    ...
    protected void envoyerEmail(){
        Log.i("Send email", "");
        String[] TO = {"abdelkabirrouagubi@gmail.com"};
        String[] CC = {""};
        ...
        try {
            ...
            Toast.makeText(contact1.this, "Pas de client mail installe", Toast.LENGTH_SHORT).show();
        }
