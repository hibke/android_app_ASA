...
public class contact2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.contact_layout2);
        ...
        bouton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                callIntent.setData(Uri.parse("tel:0612345672"));
    ...
    protected void envoyerEmail(){
        Log.i("Send email", "");
        String[] TO = {"baidourihicham@gmail.com"};
        String[] CC = {""};
        ...
        try {
            ...
            Toast.makeText(contact2.this, "Pas de client mail installe", Toast.LENGTH_SHORT).show();
        }
